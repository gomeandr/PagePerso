        ...
        <div class="column is-one-third">
            ...
            <div class="card">
                <div class="card-content skills-content">
                    <h3 class="title is-4">{{ $t('lang.lang') }}</h3>
                    <div class="content">
                        <article class="media">
                            <div class="media-content">
                                <div class="content">
                                    <p>
                                        <strong>{{ $t('lang.french') }}:</strong>
                                        <br>
